...
public class DefaultIOCGlobalConfig {
	 ...
	 */
	public @Bean(name = DefaultConf.CONFIG_NAME_IOC) IocConfig getIocConfig() {
	 ...
	 */
	public @Bean(name = DefaultConf.CONFIG_NAME_BUS) BusConfig getBusConfig() {
	 ...
	 * @return
	 */
	public @Bean(name = DefaultConf.CONFIG_NAME_CLUSTER) ClusterConfig getClusterConfig() {
